...
export const chaptersData: ChapterData[] = [
				...
				activities: [
					{
						...
						description: "An intensive hands-on workshop series covering modern HTML5 semantics, advanced CSS3 features including Grid and Flexbox, and JavaScript ES6+ concepts. Participants will build responsive layouts, implement modern UI components, and learn browser DevTools for debugging."
					},
					{
						title: "React.js Bootcamp",
						description: "A comprehensive 4-week program diving deep into React ecosystem. Learn component architecture, hooks, state management with Redux/Context, routing, and performance optimization. Build real-world applications while following industry best practices and design patterns."
					},
					{
						title: "Web Performance Workshop",
						description: "Master the art of web optimization through practical sessions covering lazy loading, code splitting, caching strategies, and modern performance APIs. Learn to use Lighthouse, Chrome DevTools, and other performance monitoring tools to analyze and improve web application speed."
					}
				],
				heads: [
					{
				...
				activities: [
					{
						...
						description: "A foundational course covering Python's data science stack including NumPy, Pandas, and Matplotlib. Learn data manipulation, statistical analysis, and visualization techniques essential for machine learning projects. Includes hands-on exercises with real-world datasets."
					},
					{
						title: "ML Models Deep Dive",
						description: "Advanced sessions exploring machine learning algorithms from theory to implementation. Cover supervised learning (regression, classification), unsupervised learning (clustering, dimensionality reduction), and neural networks. Implement models using scikit-learn and TensorFlow."
					},
					{
						title: "AI Project Showcase",
						description: "A culminating event where participants present their machine learning projects to industry professionals. Features end-to-end ML solutions, from data preprocessing to model deployment, with emphasis on real-world applications and business impact."
					}
				],
				heads: [
					{
	...
	},
	{
		...
		description: {
			...
			vision: "To lead the transformation of the power and energy sector by nurturing innovative minds capable of developing sustainable solutions for global energy challenges. We envision a future where clean, efficient energy systems power our world, designed and maintained by engineers we help develop today.",
			mission: "To cultivate expertise in power engineering and sustainable energy technologies through practical education, research opportunities, and industry collaboration. We strive to bridge the gap between academic knowledge and industrial applications, preparing our members to shape the future of energy systems."
		},
		board: [
			{
				name: "Ahmed Hassan",
				...
				activities: [
					{
						...
						description: "An in-depth exploration of modern power grid technologies featuring industry experts. Topics include grid modernization, SCADA systems, distributed energy resources, and cybersecurity in power systems. Includes virtual tours of smart grid facilities and hands-on demonstrations."
					},
					{
						title: "Renewable Energy Workshop",
						description: "Comprehensive practical sessions on renewable energy systems, focusing on solar and wind power integration. Learn system design, installation considerations, power conversion, and grid connection requirements. Includes site visits to local renewable energy installations."
					},
					{
						title: "Power Lab Sessions",
						description: "Intensive laboratory workshops using industry-standard power system simulation software. Practice power flow analysis, fault calculations, stability studies, and protection system design. Gain hands-on experience with real power system equipment and measurement tools."
					}
				],
				heads: [
					{
	...
	},
	{
		...
		description: {
			...
			vision: "To be the cornerstone of robotics innovation and education, fostering an environment where students can transform their ideas into functioning autonomous systems. We aim to prepare the next generation of robotics engineers who will shape the future of automation and artificial intelligence.",
			mission: "To advance robotics education and research by providing practical experience, theoretical knowledge, and networking opportunities. We focus on developing well-rounded engineers capable of designing, building, and programming autonomous systems while promoting collaboration and innovation in robotics."
		},
		board: [
			{
				name: "Youssef Hamdy",
				...
				activities: [
					{
						...
						description: "A comprehensive hands-on series where participants design and build autonomous robots from scratch. Cover mechanical design, electronics integration, sensor programming, and control algorithms. Work with Arduino, Raspberry Pi, and various sensors to create functional robotic systems."
					},
					{
						title: "ROS Training",
						description: "Intensive training program on Robot Operating System (ROS) framework. Learn node communication, message passing, service calls, and navigation stack implementation. Practice with simulated robots in Gazebo and deploy code on real robotic platforms."
					},
					{
						title: "Robotics Competition",
						description: "Annual team-based robotics challenge combining hardware and software skills. Teams design, build, and program robots to complete specific tasks. Includes mentoring sessions, progress reviews, and final competition judged by robotics industry professionals."
					}
				],
				heads: [
					{
	...
	},
	{
		...
		color_scheme: "#802C92",
		description: {
			about: "IEEE Women in Engineering (WIE) is dedicated to promoting women engineers and scientists while inspiring the next generation of female technologists. Our chapter creates a supportive community that celebrates diversity in engineering, provides mentorship opportunities, and empowers women to pursue leadership roles in technical fields. Through our activities, we address the unique challenges faced by women in engineering while fostering professional growth.",
			vision: "To create an inclusive engineering community where women are equally represented, celebrated, and empowered to achieve their full potential. We envision a future where gender diversity in technical fields is the norm, and where women engineers are leading technological innovations across all sectors.",
			mission: "To inspire and empower women in engineering through mentorship, skill development, and leadership opportunities. We are committed to building a strong support network, providing professional development resources, and creating platforms for women to showcase their technical achievements."
		},
		board: [
			{
				name: "Salma Mahmoud",
				...
				activities: [
					{
						...
						description: "Inspiring panel discussion featuring accomplished women leaders in technology sectors. Senior engineers and executives share their career journeys, challenges overcome, and strategies for success. Includes networking session and mentorship opportunities with speakers."
					},
					{
						title: "Leadership Workshop",
						description: "Comprehensive leadership development program focusing on essential skills for engineering managers. Topics include team dynamics, conflict resolution, strategic planning, and inclusive leadership practices. Features case studies and role-playing exercises."
					},
					{
						title: "Career Development Day",
						description: "Full-day intensive workshop on professional development in engineering. Sessions cover resume optimization, technical interview preparation, salary negotiation, and personal brand building. Includes mock interviews with industry recruiters and portfolio reviews."
					}
				],
				heads: [
					{
